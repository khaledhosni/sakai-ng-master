...
import { CustomersComponent } from 'src/app/a-qnb/customers/customers.component';
import { ReportsComponent } from 'src/app/a-qnb/reports/reports.component';
@NgModule({
    imports: [RouterModule.forChild([
        { path: 'customers', data: { breadcrumb: 'Customers' }, component:CustomersComponent },
        { path: 'reports', data: { breadcrumb: 'Customers' }, component:ReportsComponent },
